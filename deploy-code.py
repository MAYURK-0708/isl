...
while(i<num_of_videos):
    ...
    while cap.isOpened():
        ...
        # Display the frame so you can see the camera
        cv2.imshow('Recording - Press Q to stop or wait 5 seconds', frame)
        
        out.write(frame) # saves frame in file
        
        # Allow manual stop with 'q' key or auto-stop after 5 seconds
